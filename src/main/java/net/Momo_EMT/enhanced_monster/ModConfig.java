...
public class ModConfig {
    ...
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_POWERFUL;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_REGENERATING;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_SPEEDY;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_PROTECTED;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_FIRE_PROT;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_POISONOUS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_STRAY;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_WEAKENER;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_BERSERK;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_LIFESTEAL;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_TANKY;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_VOID;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_SUMMONER;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_WITHERING;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_EROSIVE;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> MANUAL_ELUSIVE;

    public static final ForgeConfigSpec.DoubleValue POWERFUL_DAMAGE_PER_LEVEL;
    public static final ForgeConfigSpec.DoubleValue SPEEDY_PER_LEVEL;
    public static final ForgeConfigSpec.DoubleValue TANKY_ARMOR_PER_LEVEL;
    public static final ForgeConfigSpec.DoubleValue TANKY_TOUGHNESS_PER_LEVEL;
    public static final ForgeConfigSpec.DoubleValue TANKY_KNOCKBACK_PER_LEVEL;
    ...
    static {
        ...
        SPEEDY_PER_LEVEL = BUILDER.comment("极速 (Speedy): 每级增加的移动速度百分比 (默认 0.2 代表 20%)")
